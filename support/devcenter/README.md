...
```ShellSession
$ ./generate.php https://lang-php.s3.dualstack.us-east-1.amazonaws.com/dist-heroku-{22,24-amd64}-stable/packages.json
```
...
```ShellSession
$ ./generate.php --third-party-extensions https://lang-php.s3.dualstack.us-east-1.amazonaws.com/dist-heroku-{22,24-amd64}-stable/packages.json
```
