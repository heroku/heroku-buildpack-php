...
class ComposerInstallerPlugin implements PluginInterface, EventSubscriberInterface
{
	...
	protected function initAllPlatformRequirements(RootPackageInterface $rootPackage, array $operations)
	{
		...
		// we also add all the root package requirements (that's how the CNB generates its "platform.json", without an intermediate "composer.json/composer.lock" package)
